...
public class SpeedEffect : MonoBehaviour {
	...
	void Update (){
		...
		Emmission = Mathf.Clamp((playerSpeed * 6 /65), 1f, 1.5f);
		...
		SpeedScale = Mathf.Clamp((playerSpeed * 3 /65), 1.15f, 1.25f);
		transform.localScale = new Vector2(SpeedScale,SpeedScale); ;

		MainTexOffSet =new Vector2 (0, (playerSpeed * 0.4f /65)-0.30f );
